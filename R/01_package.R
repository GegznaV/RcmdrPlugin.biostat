...
.onAttach <- function(libname, pkgname) {
    ...
    bs_tkimage_create("::image::bs_restart",    "icons/system-reboot-2.png")
    bs_tkimage_create("::image::bs_restart_r",  "icons/system-log-out-2.png")
    bs_tkimage_create("::image::bs_close_rcmdr","icons/system-log-out-4v.png")
    bs_tkimage_create("::image::bs_close_r",    "icons/system-shutdown-6.png")
