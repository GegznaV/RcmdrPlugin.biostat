...
window_fct_convert <- function() {
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    initializeDialog(title = gettext_Bio("Convert factor variables into other classes"))
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    dialog_values <- getDialog("window_fct_convert", defaults)
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    upper_Frame <- tkframe(top)

    variableBox <-
        variableListBox2(upper_Frame,
                         variables_fct(),                                                     # [!!!] "character" is neaded
                         selectmode       = "multiple",
                         title            = gettext_Bio("Variables (pick one or more)"),
                         initialSelection = var_pos_n(dialog_values$variables, "factor_strict"), # [!!!] "character" is neaded
                         listHeight       = 7
        )
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    onOK <- function() {
        ...
        if (length(variables) == 0) {
            errorCondition(recall = window_fct_convert,
